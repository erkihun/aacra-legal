...
class AssignAdvisoryToExpertAction
{
    ...
    public function execute(AdvisoryRequest $advisoryRequest, array $attributes, User $actor): AdvisoryRequest
    {
        ...
        if ($advisoryRequest->assigned_legal_expert_id !== null) {
            throw ValidationException::withMessages([
                'assigned_legal_expert_id' => __('A legal expert has already been assigned to this advisory request.'),
            ]);
        }
