...
class ComplaintSubmittedNotification extends Notification implements DeduplicatesNotificationDelivery, ShouldQueue
{
    use Queueable;
    ...
    {
        return $this->buildDedupeFingerprint($notifiable, $channel, 'complaint.submitted', [
