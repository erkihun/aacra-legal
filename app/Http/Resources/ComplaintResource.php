...
class ComplaintResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'complainant_city' => $this->complainant_city,
            'complainant_sub_city' => $this->complainant_sub_city,
            'complainant_woreda' => $this->complainant_woreda,
            'complainant_house_number' => $this->complainant_house_number,
            'subject' => $this->subject,
            'complaint_essence' => $this->complaint_essence,
            ...
            'incident_sub_city' => $this->incident_sub_city,
            'incident_woreda' => $this->incident_woreda,
            'concerned_employee_name' => $this->concerned_employee_name,
