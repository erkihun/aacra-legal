...
export default function ComplaintCategoryShow({ categoryItem, can }: any) {
                ...
                <SectionHeader
                    ...
                    action={
                        <div className="flex flex-wrap justify-end gap-3">
                            <BackButton fallbackHref={route('complaint-categories.index')} />
                            {can.update ? (
                                <Link href={route('complaint-categories.edit', categoryItem.id)} className="btn-base btn-primary focus-ring">
                                    {t('common.edit')}
                                </Link>
                            ) : null}
                        </div>
                ...
                <div className="grid gap-4 xl:grid-cols-[1.15fr,0.85fr]">
                    <SurfaceCard>
                        ...
                        <div className="mt-4 grid gap-4 md:grid-cols-2">
                            ...
                            <Detail label={t('complaint_categories.name_en')} value={categoryItem.name_en} />
                            <Detail label={t('complaint_categories.name_am')} value={categoryItem.name_am} />
                    ...
                    <SurfaceCard>
                        ...
                        <div className="mt-4">
                            <MetricCard label={t('navigation.complaints')} value={categoryItem.stats.complaints} />
                        </div>
                    </SurfaceCard>
                </div>
            </PageContainer>
