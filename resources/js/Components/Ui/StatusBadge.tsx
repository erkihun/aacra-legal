...
const colorMap: Record<string, string> = {
    ...
    assigned_to_department: 'bg-indigo-500/12 text-indigo-700 ring-indigo-500/18 dark:text-indigo-300',
    in_department_review: 'bg-cyan-500/12 text-cyan-700 ring-cyan-500/18 dark:text-cyan-300',
    department_responded: 'bg-emerald-500/12 text-emerald-700 ring-emerald-500/18 dark:text-emerald-300',
    escalated_to_committee: 'bg-fuchsia-500/12 text-fuchsia-700 ring-fuchsia-500/18 dark:text-fuchsia-300',
    under_committee_review: 'bg-violet-500/12 text-violet-700 ring-violet-500/18 dark:text-violet-300',
    committee_decided: 'bg-blue-500/12 text-blue-700 ring-blue-500/18 dark:text-blue-300',
    resolved: 'bg-emerald-500/12 text-emerald-700 ring-emerald-500/18 dark:text-emerald-300',
